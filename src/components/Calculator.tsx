      ...
      <div className="w-full min-h-[500px] flex flex-col items-center justify-center gap-8 py-12 animate-fade-in">
        ...
        <div className="relative w-48 h-48">
          ...
          <div className="absolute inset-0 animate-spin" style={{ animationDuration: '3s' }}>
            {/* Chart Icon */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-12 bg-success/20 rounded-xl flex items-center justify-center">
          ...
          <div className="absolute inset-0 animate-spin" style={{ animationDuration: '3s', animationDelay: '1s' }}>
            {/* Money Icon */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-12 bg-yellow-500/20 rounded-xl flex items-center justify-center">
          ...
          <div className="absolute inset-0 animate-spin" style={{ animationDuration: '3s', animationDelay: '2s' }}>
            {/* Box Icon */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-12 bg-blue-500/20 rounded-xl flex items-center justify-center">
