          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-between gap-4 md:gap-8 mb-10">
              ...
              <div className="flex flex-shrink-0">
                <div
                  className={`${getStatusColor()} w-24 h-24 md:w-36 md:h-36 lg:w-44 lg:h-44 flex items-center justify-center rounded-2xl md:rounded-3xl shadow-2xl`}
                >
            ...
            <div className="pt-6 border-t border-white/10">
              {healthResult.status === "YAXSHILASH MUMKIN" ? (
                ...
                <p className="text-amber-400 text-lg md:text-xl font-semibold leading-relaxed">
                  ...
                  yo'qotmoqdasiz inventarizatsiya qilmaganingiz uchun.
                </p>
              ) : (
                <p className="text-amber-400 text-lg md:text-xl font-semibold leading-relaxed">
                  Siz oyiga{" "}
