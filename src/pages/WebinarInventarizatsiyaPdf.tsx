...
const WebinarInventarizatsiyaPdf = () => {
  ...
  if (telegramUrl) {
    return (
      <div className="w-full min-h-screen flex flex-col items-center justify-center py-12 px-4 animate-fade-in bg-secondary/30">
        <header className="w-full flex justify-center mb-12">
          <BillzLogo className="h-10 md:h-12" />
        </header>

        <div className="text-center space-y-6 max-w-md">
          {/* Telegram Icon */}
          <div className="mx-auto w-24 h-24 bg-[#0088cc] rounded-full flex items-center justify-center shadow-xl">
          ...
          <Button
            ...
            className="inline-flex items-center justify-center gap-3 bg-[#0088cc] hover:bg-[#0077b5] text-white font-semibold text-lg px-8 py-6 rounded-full shadow-lg"
            size="lg"
          >
  ...
  return (
    <div className="min-h-screen bg-secondary/30">
      <div className="max-w-lg mx-auto px-4 py-8 pb-32">
        {/* Header */}
        <header className="w-full flex flex-col items-center gap-4 mb-10">
          <BillzLogo className="h-9 md:h-11" />
        ...
        {/* Error Message */}
        {error && (
          <div className="mt-6 p-4 bg-destructive/10 text-destructive rounded-2xl text-center font-medium">
            {error}
          </div>
        )}
      </div>
